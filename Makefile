...
src/schemas/errors/not-found.yml: src/schemas/errors/generic-error.yml.hbs
	$(DOCKER_RENDER_ERROR) '{ "code": 404, "error": "Not Found", "message": "Resource not found" }' > src/schemas/errors/not-found.yml

src/schemas/errors/server-error.yml: src/schemas/errors/generic-error.yml.hbs
	$(DOCKER_RENDER_ERROR) '{ "code": 500, "error": "Internal Server Error", "message": "Something went wrong" }' > src/schemas/errors/server-error.yml

src/schemas/errors/unauthorised.yml: src/schemas/errors/generic-error.yml.hbs
	$(DOCKER_RENDER_ERROR) '{ "code": 401, "error": "Unauthorized", "message": "Missing bearer token" }' > src/schemas/errors/unauthorised.yml
